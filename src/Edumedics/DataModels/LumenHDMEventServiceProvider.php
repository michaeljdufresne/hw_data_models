...
use Edumedics\DataModels\Listeners\LabResultView\CreateLabResultView;
use Edumedics\DataModels\Listeners\LabResultView\DeleteLabResultView;
use Edumedics\DataModels\Listeners\LabResultView\KafkaPublishLabResultView;
use Edumedics\DataModels\Listeners\LabResultView\UpdateLabResultView;
...
class LumenHDMEventServiceProvider extends BaseServiceProvider
{
    ...
    protected $listen = [
        ...
        // Labs
        LabCreate::class => [
            CreateLabResultView::class
        ],
        LabUpdate::class => [
            UpdateLabResultView::class
        ],
        LabDelete::class => [
            DeleteLabResultView::class
        ],
